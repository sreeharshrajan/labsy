...
import { updateContentLayout } from "@/lib/utils/layout";
import { updateThemeMode, updateThemePreset } from "@/lib/utils/theme";
...
export function LayoutControls(props: LayoutControlsProps) {
  ...
  return (
    <Popover>
      ...
      <PopoverContent
        className={themeMode === "dark" ? "bg-gray-800" : "bg-white"}
        align="end"
      >
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <Select value={themePreset} onValueChange={(value) => handleValueChange("theme_preset", value)}>
                ...
                <SelectContent className={themeMode === "dark" ? "bg-gray-800" : "bg-white"}>
