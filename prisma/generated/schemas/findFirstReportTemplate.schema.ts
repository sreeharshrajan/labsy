...
export const ReportTemplateFindFirstSelectSchema: z.ZodType<Prisma.ReportTemplateSelect> = z.object({
...
export const ReportTemplateFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    unit: z.boolean().optional(),
    reference: z.boolean().optional(),
