...
const subscriptionscalarwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => SubscriptionScalarWhereInputObjectSchema), z.lazy(() => SubscriptionScalarWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => SubscriptionScalarWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => SubscriptionScalarWhereInputObjectSchema), z.lazy(() => SubscriptionScalarWhereInputObjectSchema).array()]).optional(),
...
export const SubscriptionScalarWhereInputObjectSchema: z.ZodType<Prisma.SubscriptionScalarWhereInput> = subscriptionscalarwhereinputSchema as unknown as z.ZodType<Prisma.SubscriptionScalarWhereInput>;
export const SubscriptionScalarWhereInputObjectZodSchema = subscriptionscalarwhereinputSchema;
