...
import { TenantUserUserIdTenantIdCompoundUniqueInputObjectSchema } from './TenantUserUserIdTenantIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  userId_tenantId: z.lazy(() => TenantUserUserIdTenantIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["userId","tenantId"]] as string[][];
...
export const TenantUserWhereUniqueInputObjectSchema: z.ZodType<Prisma.TenantUserWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.TenantUserWhereUniqueInput>;
export const TenantUserWhereUniqueInputObjectZodSchema = makeSchema();
