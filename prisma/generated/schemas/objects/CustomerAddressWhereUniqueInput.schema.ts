...
import { CustomerAddressCustomerIdAddressIdCompoundUniqueInputObjectSchema } from './CustomerAddressCustomerIdAddressIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  customerId_addressId: z.lazy(() => CustomerAddressCustomerIdAddressIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["customerId","addressId"]] as string[][];
...
export const CustomerAddressWhereUniqueInputObjectSchema: z.ZodType<Prisma.CustomerAddressWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.CustomerAddressWhereUniqueInput>;
export const CustomerAddressWhereUniqueInputObjectZodSchema = makeSchema();
