...
import { TenantAddressTenantIdAddressIdCompoundUniqueInputObjectSchema } from './TenantAddressTenantIdAddressIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  tenantId_addressId: z.lazy(() => TenantAddressTenantIdAddressIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["tenantId","addressId"]] as string[][];
...
export const TenantAddressWhereUniqueInputObjectSchema: z.ZodType<Prisma.TenantAddressWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.TenantAddressWhereUniqueInput>;
export const TenantAddressWhereUniqueInputObjectZodSchema = makeSchema();
