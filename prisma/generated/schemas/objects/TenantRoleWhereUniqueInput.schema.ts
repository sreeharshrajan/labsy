...
import { TenantRoleTenantIdNameCompoundUniqueInputObjectSchema } from './TenantRoleTenantIdNameCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  tenantId_name: z.lazy(() => TenantRoleTenantIdNameCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["tenantId","name"]] as string[][];
...
export const TenantRoleWhereUniqueInputObjectSchema: z.ZodType<Prisma.TenantRoleWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.TenantRoleWhereUniqueInput>;
export const TenantRoleWhereUniqueInputObjectZodSchema = makeSchema();
