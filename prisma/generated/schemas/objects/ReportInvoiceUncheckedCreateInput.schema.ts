...
const makeSchema = () => z.object({
  ...
  items: z.lazy(() => ReportInvoiceItemUncheckedCreateNestedManyWithoutInvoiceInputObjectSchema),
  payments: z.lazy(() => ReportInvoicePaymentUncheckedCreateNestedManyWithoutInvoiceInputObjectSchema),
  logs: z.lazy(() => DoctorCommissionLogUncheckedCreateNestedManyWithoutInvoiceInputObjectSchema),
  Report: z.lazy(() => ReportUncheckedCreateNestedManyWithoutInvoiceInputObjectSchema)
}).strict();
export const ReportInvoiceUncheckedCreateInputObjectSchema: z.ZodType<Prisma.ReportInvoiceUncheckedCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.ReportInvoiceUncheckedCreateInput>;
export const ReportInvoiceUncheckedCreateInputObjectZodSchema = makeSchema();
