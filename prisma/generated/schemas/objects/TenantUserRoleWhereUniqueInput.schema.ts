...
import { TenantUserRoleTenantUserIdRoleIdCompoundUniqueInputObjectSchema } from './TenantUserRoleTenantUserIdRoleIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  tenantUserId_roleId: z.lazy(() => TenantUserRoleTenantUserIdRoleIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["tenantUserId","roleId"]] as string[][];
...
export const TenantUserRoleWhereUniqueInputObjectSchema: z.ZodType<Prisma.TenantUserRoleWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.TenantUserRoleWhereUniqueInput>;
export const TenantUserRoleWhereUniqueInputObjectZodSchema = makeSchema();
