...
import { UserAddressUserIdAddressIdCompoundUniqueInputObjectSchema } from './UserAddressUserIdAddressIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  userId_addressId: z.lazy(() => UserAddressUserIdAddressIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["userId","addressId"]] as string[][];
...
export const UserAddressWhereUniqueInputObjectSchema: z.ZodType<Prisma.UserAddressWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.UserAddressWhereUniqueInput>;
export const UserAddressWhereUniqueInputObjectZodSchema = makeSchema();
