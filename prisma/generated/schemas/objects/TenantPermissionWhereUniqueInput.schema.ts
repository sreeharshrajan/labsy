...
import { TenantPermissionRoleIdActionResourceCompoundUniqueInputObjectSchema } from './TenantPermissionRoleIdActionResourceCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  roleId_action_resource: z.lazy(() => TenantPermissionRoleIdActionResourceCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["roleId","action","resource"]] as string[][];
...
export const TenantPermissionWhereUniqueInputObjectSchema: z.ZodType<Prisma.TenantPermissionWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.TenantPermissionWhereUniqueInput>;
export const TenantPermissionWhereUniqueInputObjectZodSchema = makeSchema();
