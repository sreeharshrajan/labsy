...
import { UserAddressUpdateManyWithoutAddressNestedInputObjectSchema } from './UserAddressUpdateManyWithoutAddressNestedInput.schema';
...
const makeSchema = () => z.object({
  ...
  userAddresses: z.lazy(() => UserAddressUpdateManyWithoutAddressNestedInputObjectSchema).optional(),
  doctorAddresses: z.lazy(() => DoctorAddressUpdateManyWithoutAddressNestedInputObjectSchema).optional()
}).strict();
export const AddressUpdateWithoutCustomerAddressesInputObjectSchema: z.ZodType<Prisma.AddressUpdateWithoutCustomerAddressesInput> = makeSchema() as unknown as z.ZodType<Prisma.AddressUpdateWithoutCustomerAddressesInput>;
export const AddressUpdateWithoutCustomerAddressesInputObjectZodSchema = makeSchema();
