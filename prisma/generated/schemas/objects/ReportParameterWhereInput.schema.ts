...
import { ReportTemplateScalarRelationFilterObjectSchema } from './ReportTemplateScalarRelationFilter.schema';
...
const reportparameterwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => ReportParameterWhereInputObjectSchema), z.lazy(() => ReportParameterWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => ReportParameterWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => ReportParameterWhereInputObjectSchema), z.lazy(() => ReportParameterWhereInputObjectSchema).array()]).optional(),
  ...
  template: z.union([z.lazy(() => ReportTemplateScalarRelationFilterObjectSchema), z.lazy(() => ReportTemplateWhereInputObjectSchema)]).optional(),
  details: z.lazy(() => ReportDetailListRelationFilterObjectSchema).optional()
}).strict();
export const ReportParameterWhereInputObjectSchema: z.ZodType<Prisma.ReportParameterWhereInput> = reportparameterwhereinputSchema as unknown as z.ZodType<Prisma.ReportParameterWhereInput>;
export const ReportParameterWhereInputObjectZodSchema = reportparameterwhereinputSchema;
