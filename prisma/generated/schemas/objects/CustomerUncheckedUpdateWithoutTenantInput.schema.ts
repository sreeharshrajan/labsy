...
import { ReportInvoiceUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema } from './ReportInvoiceUncheckedUpdateManyWithoutCustomerNestedInput.schema';
import { ReportUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema } from './ReportUncheckedUpdateManyWithoutCustomerNestedInput.schema';
import { CustomerAddressUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema } from './CustomerAddressUncheckedUpdateManyWithoutCustomerNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  ReportInvoice: z.lazy(() => ReportInvoiceUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema).optional(),
  Report: z.lazy(() => ReportUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema).optional(),
  customerAddresses: z.lazy(() => CustomerAddressUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema).optional()
}).strict();
export const CustomerUncheckedUpdateWithoutTenantInputObjectSchema: z.ZodType<Prisma.CustomerUncheckedUpdateWithoutTenantInput> = makeSchema() as unknown as z.ZodType<Prisma.CustomerUncheckedUpdateWithoutTenantInput>;
export const CustomerUncheckedUpdateWithoutTenantInputObjectZodSchema = makeSchema();
