...
import { DoctorAddressDoctorIdAddressIdCompoundUniqueInputObjectSchema } from './DoctorAddressDoctorIdAddressIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  doctorId_addressId: z.lazy(() => DoctorAddressDoctorIdAddressIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["doctorId","addressId"]] as string[][];
...
export const DoctorAddressWhereUniqueInputObjectSchema: z.ZodType<Prisma.DoctorAddressWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.DoctorAddressWhereUniqueInput>;
export const DoctorAddressWhereUniqueInputObjectZodSchema = makeSchema();
