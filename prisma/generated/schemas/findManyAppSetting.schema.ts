...
export const AppSettingFindManySelectSchema: z.ZodType<Prisma.AppSettingSelect> = z.object({
...
export const AppSettingFindManySchema: z.ZodType<Prisma.AppSettingFindManyArgs> = z.object({ select: AppSettingFindManySelectSchema.optional(), include: z.lazy(() => AppSettingIncludeObjectSchema.optional()), orderBy: z.union([AppSettingOrderByWithRelationInputObjectSchema, AppSettingOrderByWithRelationInputObjectSchema.array()]).optional(), where: AppSettingWhereInputObjectSchema.optional(), cursor: AppSettingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AppSettingScalarFieldEnumSchema, AppSettingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AppSettingFindManyArgs>;

export const AppSettingFindManyZodSchema = z.object({ select: AppSettingFindManySelectSchema.optional(), include: z.lazy(() => AppSettingIncludeObjectSchema.optional()), orderBy: z.union([AppSettingOrderByWithRelationInputObjectSchema, AppSettingOrderByWithRelationInputObjectSchema.array()]).optional(), where: AppSettingWhereInputObjectSchema.optional(), cursor: AppSettingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AppSettingScalarFieldEnumSchema, AppSettingScalarFieldEnumSchema.array()]).optional() }).strict();