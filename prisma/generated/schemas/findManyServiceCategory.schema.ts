...
export const ServiceCategoryFindManySelectSchema: z.ZodType<Prisma.ServiceCategorySelect> = z.object({
...
export const ServiceCategoryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    deletedAt: z.boolean().optional(),
...
export const ServiceCategoryFindManySchema: z.ZodType<Prisma.ServiceCategoryFindManyArgs> = z.object({ select: ServiceCategoryFindManySelectSchema.optional(), include: z.lazy(() => ServiceCategoryIncludeObjectSchema.optional()), orderBy: z.union([ServiceCategoryOrderByWithRelationInputObjectSchema, ServiceCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ServiceCategoryWhereInputObjectSchema.optional(), cursor: ServiceCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ServiceCategoryScalarFieldEnumSchema, ServiceCategoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ServiceCategoryFindManyArgs>;

export const ServiceCategoryFindManyZodSchema = z.object({ select: ServiceCategoryFindManySelectSchema.optional(), include: z.lazy(() => ServiceCategoryIncludeObjectSchema.optional()), orderBy: z.union([ServiceCategoryOrderByWithRelationInputObjectSchema, ServiceCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ServiceCategoryWhereInputObjectSchema.optional(), cursor: ServiceCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ServiceCategoryScalarFieldEnumSchema, ServiceCategoryScalarFieldEnumSchema.array()]).optional() }).strict();