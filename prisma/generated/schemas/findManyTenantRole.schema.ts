...
export const TenantRoleFindManySelectSchema: z.ZodType<Prisma.TenantRoleSelect> = z.object({
...
export const TenantRoleFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    isSystem: z.boolean().optional(),
...
export const TenantRoleFindManySchema: z.ZodType<Prisma.TenantRoleFindManyArgs> = z.object({ select: TenantRoleFindManySelectSchema.optional(), include: z.lazy(() => TenantRoleIncludeObjectSchema.optional()), orderBy: z.union([TenantRoleOrderByWithRelationInputObjectSchema, TenantRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantRoleWhereInputObjectSchema.optional(), cursor: TenantRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantRoleScalarFieldEnumSchema, TenantRoleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TenantRoleFindManyArgs>;

export const TenantRoleFindManyZodSchema = z.object({ select: TenantRoleFindManySelectSchema.optional(), include: z.lazy(() => TenantRoleIncludeObjectSchema.optional()), orderBy: z.union([TenantRoleOrderByWithRelationInputObjectSchema, TenantRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantRoleWhereInputObjectSchema.optional(), cursor: TenantRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantRoleScalarFieldEnumSchema, TenantRoleScalarFieldEnumSchema.array()]).optional() }).strict();