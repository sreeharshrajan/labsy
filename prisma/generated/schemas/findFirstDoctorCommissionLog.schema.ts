...
export const DoctorCommissionLogFindFirstSelectSchema: z.ZodType<Prisma.DoctorCommissionLogSelect> = z.object({
...
export const DoctorCommissionLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    doctorId: z.boolean().optional(),
    invoiceId: z.boolean().optional(),
    commissionId: z.boolean().optional(),
...
export const DoctorCommissionLogFindFirstSchema: z.ZodType<Prisma.DoctorCommissionLogFindFirstArgs> = z.object({ select: DoctorCommissionLogFindFirstSelectSchema.optional(), include: z.lazy(() => DoctorCommissionLogIncludeObjectSchema.optional()), orderBy: z.union([DoctorCommissionLogOrderByWithRelationInputObjectSchema, DoctorCommissionLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorCommissionLogWhereInputObjectSchema.optional(), cursor: DoctorCommissionLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorCommissionLogScalarFieldEnumSchema, DoctorCommissionLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DoctorCommissionLogFindFirstArgs>;

export const DoctorCommissionLogFindFirstZodSchema = z.object({ select: DoctorCommissionLogFindFirstSelectSchema.optional(), include: z.lazy(() => DoctorCommissionLogIncludeObjectSchema.optional()), orderBy: z.union([DoctorCommissionLogOrderByWithRelationInputObjectSchema, DoctorCommissionLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorCommissionLogWhereInputObjectSchema.optional(), cursor: DoctorCommissionLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorCommissionLogScalarFieldEnumSchema, DoctorCommissionLogScalarFieldEnumSchema.array()]).optional() }).strict();