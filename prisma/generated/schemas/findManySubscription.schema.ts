...
export const SubscriptionFindManySelectSchema: z.ZodType<Prisma.SubscriptionSelect> = z.object({
...
export const SubscriptionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    plan: z.boolean().optional(),
    status: z.boolean().optional(),
    startDate: z.boolean().optional(),
...
export const SubscriptionFindManySchema: z.ZodType<Prisma.SubscriptionFindManyArgs> = z.object({ select: SubscriptionFindManySelectSchema.optional(), include: z.lazy(() => SubscriptionIncludeObjectSchema.optional()), orderBy: z.union([SubscriptionOrderByWithRelationInputObjectSchema, SubscriptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: SubscriptionWhereInputObjectSchema.optional(), cursor: SubscriptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SubscriptionScalarFieldEnumSchema, SubscriptionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SubscriptionFindManyArgs>;

export const SubscriptionFindManyZodSchema = z.object({ select: SubscriptionFindManySelectSchema.optional(), include: z.lazy(() => SubscriptionIncludeObjectSchema.optional()), orderBy: z.union([SubscriptionOrderByWithRelationInputObjectSchema, SubscriptionOrderByWithRelationInputObjectSchema.array()]).optional(), where: SubscriptionWhereInputObjectSchema.optional(), cursor: SubscriptionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SubscriptionScalarFieldEnumSchema, SubscriptionScalarFieldEnumSchema.array()]).optional() }).strict();