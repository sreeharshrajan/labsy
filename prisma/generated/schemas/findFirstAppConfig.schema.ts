...
export const AppConfigFindFirstSelectSchema: z.ZodType<Prisma.AppConfigSelect> = z.object({
...
export const AppConfigFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    appName: z.boolean().optional(),
    appVersion: z.boolean().optional(),
    appLogo: z.boolean().optional(),
