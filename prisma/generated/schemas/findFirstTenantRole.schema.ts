...
export const TenantRoleFindFirstSelectSchema: z.ZodType<Prisma.TenantRoleSelect> = z.object({
...
export const TenantRoleFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    isSystem: z.boolean().optional(),
...
export const TenantRoleFindFirstSchema: z.ZodType<Prisma.TenantRoleFindFirstArgs> = z.object({ select: TenantRoleFindFirstSelectSchema.optional(), include: z.lazy(() => TenantRoleIncludeObjectSchema.optional()), orderBy: z.union([TenantRoleOrderByWithRelationInputObjectSchema, TenantRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantRoleWhereInputObjectSchema.optional(), cursor: TenantRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantRoleScalarFieldEnumSchema, TenantRoleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TenantRoleFindFirstArgs>;

export const TenantRoleFindFirstZodSchema = z.object({ select: TenantRoleFindFirstSelectSchema.optional(), include: z.lazy(() => TenantRoleIncludeObjectSchema.optional()), orderBy: z.union([TenantRoleOrderByWithRelationInputObjectSchema, TenantRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantRoleWhereInputObjectSchema.optional(), cursor: TenantRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantRoleScalarFieldEnumSchema, TenantRoleScalarFieldEnumSchema.array()]).optional() }).strict();