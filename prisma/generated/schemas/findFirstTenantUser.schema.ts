...
export const TenantUserFindFirstSelectSchema: z.ZodType<Prisma.TenantUserSelect> = z.object({
...
export const TenantUserFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    deletedAt: z.boolean().optional(),
...
export const TenantUserFindFirstSchema: z.ZodType<Prisma.TenantUserFindFirstArgs> = z.object({ select: TenantUserFindFirstSelectSchema.optional(), include: z.lazy(() => TenantUserIncludeObjectSchema.optional()), orderBy: z.union([TenantUserOrderByWithRelationInputObjectSchema, TenantUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantUserWhereInputObjectSchema.optional(), cursor: TenantUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantUserScalarFieldEnumSchema, TenantUserScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TenantUserFindFirstArgs>;

export const TenantUserFindFirstZodSchema = z.object({ select: TenantUserFindFirstSelectSchema.optional(), include: z.lazy(() => TenantUserIncludeObjectSchema.optional()), orderBy: z.union([TenantUserOrderByWithRelationInputObjectSchema, TenantUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantUserWhereInputObjectSchema.optional(), cursor: TenantUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantUserScalarFieldEnumSchema, TenantUserScalarFieldEnumSchema.array()]).optional() }).strict();