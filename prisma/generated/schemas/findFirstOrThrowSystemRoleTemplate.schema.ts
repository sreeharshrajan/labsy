...
export const SystemRoleTemplateFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SystemRoleTemplateSelect> = z.object({
...
export const SystemRoleTemplateFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    role: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const SystemRoleTemplateFindFirstOrThrowSchema: z.ZodType<Prisma.SystemRoleTemplateFindFirstOrThrowArgs> = z.object({ select: SystemRoleTemplateFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SystemRoleTemplateIncludeObjectSchema.optional()), orderBy: z.union([SystemRoleTemplateOrderByWithRelationInputObjectSchema, SystemRoleTemplateOrderByWithRelationInputObjectSchema.array()]).optional(), where: SystemRoleTemplateWhereInputObjectSchema.optional(), cursor: SystemRoleTemplateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemRoleTemplateScalarFieldEnumSchema, SystemRoleTemplateScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SystemRoleTemplateFindFirstOrThrowArgs>;

export const SystemRoleTemplateFindFirstOrThrowZodSchema = z.object({ select: SystemRoleTemplateFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SystemRoleTemplateIncludeObjectSchema.optional()), orderBy: z.union([SystemRoleTemplateOrderByWithRelationInputObjectSchema, SystemRoleTemplateOrderByWithRelationInputObjectSchema.array()]).optional(), where: SystemRoleTemplateWhereInputObjectSchema.optional(), cursor: SystemRoleTemplateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemRoleTemplateScalarFieldEnumSchema, SystemRoleTemplateScalarFieldEnumSchema.array()]).optional() }).strict();