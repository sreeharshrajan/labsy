...
export const CustomerAddressFindManySelectSchema: z.ZodType<Prisma.CustomerAddressSelect> = z.object({
...
export const CustomerAddressFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    customerId: z.boolean().optional(),
    addressId: z.boolean().optional(),
    isPrimary: z.boolean().optional(),
...
export const CustomerAddressFindManySchema: z.ZodType<Prisma.CustomerAddressFindManyArgs> = z.object({ select: CustomerAddressFindManySelectSchema.optional(), include: z.lazy(() => CustomerAddressIncludeObjectSchema.optional()), orderBy: z.union([CustomerAddressOrderByWithRelationInputObjectSchema, CustomerAddressOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomerAddressWhereInputObjectSchema.optional(), cursor: CustomerAddressWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomerAddressScalarFieldEnumSchema, CustomerAddressScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CustomerAddressFindManyArgs>;

export const CustomerAddressFindManyZodSchema = z.object({ select: CustomerAddressFindManySelectSchema.optional(), include: z.lazy(() => CustomerAddressIncludeObjectSchema.optional()), orderBy: z.union([CustomerAddressOrderByWithRelationInputObjectSchema, CustomerAddressOrderByWithRelationInputObjectSchema.array()]).optional(), where: CustomerAddressWhereInputObjectSchema.optional(), cursor: CustomerAddressWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomerAddressScalarFieldEnumSchema, CustomerAddressScalarFieldEnumSchema.array()]).optional() }).strict();