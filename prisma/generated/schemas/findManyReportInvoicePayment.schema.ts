...
export const ReportInvoicePaymentFindManySelectSchema: z.ZodType<Prisma.ReportInvoicePaymentSelect> = z.object({
...
export const ReportInvoicePaymentFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    amount: z.boolean().optional(),
    method: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const ReportInvoicePaymentFindManySchema: z.ZodType<Prisma.ReportInvoicePaymentFindManyArgs> = z.object({ select: ReportInvoicePaymentFindManySelectSchema.optional(), include: z.lazy(() => ReportInvoicePaymentIncludeObjectSchema.optional()), orderBy: z.union([ReportInvoicePaymentOrderByWithRelationInputObjectSchema, ReportInvoicePaymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportInvoicePaymentWhereInputObjectSchema.optional(), cursor: ReportInvoicePaymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportInvoicePaymentScalarFieldEnumSchema, ReportInvoicePaymentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReportInvoicePaymentFindManyArgs>;

export const ReportInvoicePaymentFindManyZodSchema = z.object({ select: ReportInvoicePaymentFindManySelectSchema.optional(), include: z.lazy(() => ReportInvoicePaymentIncludeObjectSchema.optional()), orderBy: z.union([ReportInvoicePaymentOrderByWithRelationInputObjectSchema, ReportInvoicePaymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportInvoicePaymentWhereInputObjectSchema.optional(), cursor: ReportInvoicePaymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportInvoicePaymentScalarFieldEnumSchema, ReportInvoicePaymentScalarFieldEnumSchema.array()]).optional() }).strict();