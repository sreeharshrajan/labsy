...
export const DoctorCommissionLogFindManySelectSchema: z.ZodType<Prisma.DoctorCommissionLogSelect> = z.object({
...
export const DoctorCommissionLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    doctorId: z.boolean().optional(),
    invoiceId: z.boolean().optional(),
    commissionId: z.boolean().optional(),
...
export const DoctorCommissionLogFindManySchema: z.ZodType<Prisma.DoctorCommissionLogFindManyArgs> = z.object({ select: DoctorCommissionLogFindManySelectSchema.optional(), include: z.lazy(() => DoctorCommissionLogIncludeObjectSchema.optional()), orderBy: z.union([DoctorCommissionLogOrderByWithRelationInputObjectSchema, DoctorCommissionLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorCommissionLogWhereInputObjectSchema.optional(), cursor: DoctorCommissionLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorCommissionLogScalarFieldEnumSchema, DoctorCommissionLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DoctorCommissionLogFindManyArgs>;

export const DoctorCommissionLogFindManyZodSchema = z.object({ select: DoctorCommissionLogFindManySelectSchema.optional(), include: z.lazy(() => DoctorCommissionLogIncludeObjectSchema.optional()), orderBy: z.union([DoctorCommissionLogOrderByWithRelationInputObjectSchema, DoctorCommissionLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorCommissionLogWhereInputObjectSchema.optional(), cursor: DoctorCommissionLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorCommissionLogScalarFieldEnumSchema, DoctorCommissionLogScalarFieldEnumSchema.array()]).optional() }).strict();