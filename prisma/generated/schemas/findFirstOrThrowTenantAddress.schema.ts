...
export const TenantAddressFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TenantAddressSelect> = z.object({
...
export const TenantAddressFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    tenantId: z.boolean().optional(),
    addressId: z.boolean().optional(),
    isPrimary: z.boolean().optional(),
...
export const TenantAddressFindFirstOrThrowSchema: z.ZodType<Prisma.TenantAddressFindFirstOrThrowArgs> = z.object({ select: TenantAddressFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TenantAddressIncludeObjectSchema.optional()), orderBy: z.union([TenantAddressOrderByWithRelationInputObjectSchema, TenantAddressOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantAddressWhereInputObjectSchema.optional(), cursor: TenantAddressWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantAddressScalarFieldEnumSchema, TenantAddressScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TenantAddressFindFirstOrThrowArgs>;

export const TenantAddressFindFirstOrThrowZodSchema = z.object({ select: TenantAddressFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TenantAddressIncludeObjectSchema.optional()), orderBy: z.union([TenantAddressOrderByWithRelationInputObjectSchema, TenantAddressOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantAddressWhereInputObjectSchema.optional(), cursor: TenantAddressWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantAddressScalarFieldEnumSchema, TenantAddressScalarFieldEnumSchema.array()]).optional() }).strict();