...
export const SyncLogFindFirstSelectSchema: z.ZodType<Prisma.SyncLogSelect> = z.object({
...
export const SyncLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    tenantId: z.boolean().optional(),
    entity: z.boolean().optional(),
    entityId: z.boolean().optional(),
...
export const SyncLogFindFirstSchema: z.ZodType<Prisma.SyncLogFindFirstArgs> = z.object({ select: SyncLogFindFirstSelectSchema.optional(), include: z.lazy(() => SyncLogIncludeObjectSchema.optional()), orderBy: z.union([SyncLogOrderByWithRelationInputObjectSchema, SyncLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: SyncLogWhereInputObjectSchema.optional(), cursor: SyncLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SyncLogScalarFieldEnumSchema, SyncLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SyncLogFindFirstArgs>;

export const SyncLogFindFirstZodSchema = z.object({ select: SyncLogFindFirstSelectSchema.optional(), include: z.lazy(() => SyncLogIncludeObjectSchema.optional()), orderBy: z.union([SyncLogOrderByWithRelationInputObjectSchema, SyncLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: SyncLogWhereInputObjectSchema.optional(), cursor: SyncLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SyncLogScalarFieldEnumSchema, SyncLogScalarFieldEnumSchema.array()]).optional() }).strict();