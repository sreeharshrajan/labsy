...
export const UserAddressFindManySelectSchema: z.ZodType<Prisma.UserAddressSelect> = z.object({
...
export const UserAddressFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    addressId: z.boolean().optional(),
    isPrimary: z.boolean().optional(),
