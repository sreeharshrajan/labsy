...
export const ReportInvoiceFindFirstSelectSchema: z.ZodType<Prisma.ReportInvoiceSelect> = z.object({
...
export const ReportInvoiceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    totalAmount: z.boolean().optional(),
    discount: z.boolean().optional(),
    netAmount: z.boolean().optional(),
...
export const ReportInvoiceFindFirstSchema: z.ZodType<Prisma.ReportInvoiceFindFirstArgs> = z.object({ select: ReportInvoiceFindFirstSelectSchema.optional(), include: z.lazy(() => ReportInvoiceIncludeObjectSchema.optional()), orderBy: z.union([ReportInvoiceOrderByWithRelationInputObjectSchema, ReportInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportInvoiceWhereInputObjectSchema.optional(), cursor: ReportInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportInvoiceScalarFieldEnumSchema, ReportInvoiceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReportInvoiceFindFirstArgs>;

export const ReportInvoiceFindFirstZodSchema = z.object({ select: ReportInvoiceFindFirstSelectSchema.optional(), include: z.lazy(() => ReportInvoiceIncludeObjectSchema.optional()), orderBy: z.union([ReportInvoiceOrderByWithRelationInputObjectSchema, ReportInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportInvoiceWhereInputObjectSchema.optional(), cursor: ReportInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportInvoiceScalarFieldEnumSchema, ReportInvoiceScalarFieldEnumSchema.array()]).optional() }).strict();