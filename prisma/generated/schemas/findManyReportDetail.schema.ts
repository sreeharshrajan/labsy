...
export const ReportDetailFindManySelectSchema: z.ZodType<Prisma.ReportDetailSelect> = z.object({
...
export const ReportDetailFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    parameterName: z.boolean().optional(),
    parameterUnit: z.boolean().optional(),
    parameterReferenceMin: z.boolean().optional(),
...
export const ReportDetailFindManySchema: z.ZodType<Prisma.ReportDetailFindManyArgs> = z.object({ select: ReportDetailFindManySelectSchema.optional(), include: z.lazy(() => ReportDetailIncludeObjectSchema.optional()), orderBy: z.union([ReportDetailOrderByWithRelationInputObjectSchema, ReportDetailOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportDetailWhereInputObjectSchema.optional(), cursor: ReportDetailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportDetailScalarFieldEnumSchema, ReportDetailScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReportDetailFindManyArgs>;

export const ReportDetailFindManyZodSchema = z.object({ select: ReportDetailFindManySelectSchema.optional(), include: z.lazy(() => ReportDetailIncludeObjectSchema.optional()), orderBy: z.union([ReportDetailOrderByWithRelationInputObjectSchema, ReportDetailOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportDetailWhereInputObjectSchema.optional(), cursor: ReportDetailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportDetailScalarFieldEnumSchema, ReportDetailScalarFieldEnumSchema.array()]).optional() }).strict();