...
export const UserAddressUpdateManySchema = z.object({ data: UserAddressUpdateManyMutationInputObjectSchema, where: UserAddressWhereInputObjectSchema.optional()  })