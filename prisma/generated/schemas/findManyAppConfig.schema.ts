...
export const AppConfigFindManySelectSchema: z.ZodType<Prisma.AppConfigSelect> = z.object({
...
export const AppConfigFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    appName: z.boolean().optional(),
    appVersion: z.boolean().optional(),
    appLogo: z.boolean().optional(),
...
export const AppConfigFindManySchema: z.ZodType<Prisma.AppConfigFindManyArgs> = z.object({ select: AppConfigFindManySelectSchema.optional(),  orderBy: z.union([AppConfigOrderByWithRelationInputObjectSchema, AppConfigOrderByWithRelationInputObjectSchema.array()]).optional(), where: AppConfigWhereInputObjectSchema.optional(), cursor: AppConfigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AppConfigScalarFieldEnumSchema, AppConfigScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AppConfigFindManyArgs>;

export const AppConfigFindManyZodSchema = z.object({ select: AppConfigFindManySelectSchema.optional(),  orderBy: z.union([AppConfigOrderByWithRelationInputObjectSchema, AppConfigOrderByWithRelationInputObjectSchema.array()]).optional(), where: AppConfigWhereInputObjectSchema.optional(), cursor: AppConfigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AppConfigScalarFieldEnumSchema, AppConfigScalarFieldEnumSchema.array()]).optional() }).strict();