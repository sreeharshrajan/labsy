...
export const PostUpdateOneSchema = z.object({ select: PostSelectObjectSchema.optional(), include: PostIncludeObjectSchema.optional(), data: z.union([PostUpdateInputObjectSchema, PostUncheckedUpdateInputObjectSchema]), where: PostWhereUniqueInputObjectSchema  })