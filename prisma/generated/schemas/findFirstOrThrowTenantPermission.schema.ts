...
export const TenantPermissionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TenantPermissionSelect> = z.object({
...
export const TenantPermissionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    action: z.boolean().optional(),
    resource: z.boolean().optional(),
    roleId: z.boolean().optional(),
...
export const TenantPermissionFindFirstOrThrowSchema: z.ZodType<Prisma.TenantPermissionFindFirstOrThrowArgs> = z.object({ select: TenantPermissionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TenantPermissionIncludeObjectSchema.optional()), orderBy: z.union([TenantPermissionOrderByWithRelationInputObjectSchema, TenantPermissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantPermissionWhereInputObjectSchema.optional(), cursor: TenantPermissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantPermissionScalarFieldEnumSchema, TenantPermissionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TenantPermissionFindFirstOrThrowArgs>;

export const TenantPermissionFindFirstOrThrowZodSchema = z.object({ select: TenantPermissionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TenantPermissionIncludeObjectSchema.optional()), orderBy: z.union([TenantPermissionOrderByWithRelationInputObjectSchema, TenantPermissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: TenantPermissionWhereInputObjectSchema.optional(), cursor: TenantPermissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TenantPermissionScalarFieldEnumSchema, TenantPermissionScalarFieldEnumSchema.array()]).optional() }).strict();