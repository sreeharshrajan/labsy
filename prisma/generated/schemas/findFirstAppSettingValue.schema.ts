...
export const AppSettingValueFindFirstSelectSchema: z.ZodType<Prisma.AppSettingValueSelect> = z.object({
...
export const AppSettingValueFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    settingId: z.boolean().optional(),
    setting: z.boolean().optional(),
    value: z.boolean().optional(),
...
export const AppSettingValueFindFirstSchema: z.ZodType<Prisma.AppSettingValueFindFirstArgs> = z.object({ select: AppSettingValueFindFirstSelectSchema.optional(), include: z.lazy(() => AppSettingValueIncludeObjectSchema.optional()), orderBy: z.union([AppSettingValueOrderByWithRelationInputObjectSchema, AppSettingValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: AppSettingValueWhereInputObjectSchema.optional(), cursor: AppSettingValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AppSettingValueScalarFieldEnumSchema, AppSettingValueScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AppSettingValueFindFirstArgs>;

export const AppSettingValueFindFirstZodSchema = z.object({ select: AppSettingValueFindFirstSelectSchema.optional(), include: z.lazy(() => AppSettingValueIncludeObjectSchema.optional()), orderBy: z.union([AppSettingValueOrderByWithRelationInputObjectSchema, AppSettingValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: AppSettingValueWhereInputObjectSchema.optional(), cursor: AppSettingValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AppSettingValueScalarFieldEnumSchema, AppSettingValueScalarFieldEnumSchema.array()]).optional() }).strict();