...
export const ReportParameterFindManySelectSchema: z.ZodType<Prisma.ReportParameterSelect> = z.object({
...
export const ReportParameterFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    unit: z.boolean().optional(),
    method: z.boolean().optional(),
...
export const ReportParameterFindManySchema: z.ZodType<Prisma.ReportParameterFindManyArgs> = z.object({ select: ReportParameterFindManySelectSchema.optional(), include: z.lazy(() => ReportParameterIncludeObjectSchema.optional()), orderBy: z.union([ReportParameterOrderByWithRelationInputObjectSchema, ReportParameterOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportParameterWhereInputObjectSchema.optional(), cursor: ReportParameterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportParameterScalarFieldEnumSchema, ReportParameterScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReportParameterFindManyArgs>;

export const ReportParameterFindManyZodSchema = z.object({ select: ReportParameterFindManySelectSchema.optional(), include: z.lazy(() => ReportParameterIncludeObjectSchema.optional()), orderBy: z.union([ReportParameterOrderByWithRelationInputObjectSchema, ReportParameterOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportParameterWhereInputObjectSchema.optional(), cursor: ReportParameterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportParameterScalarFieldEnumSchema, ReportParameterScalarFieldEnumSchema.array()]).optional() }).strict();