...
export const ServiceFindManySelectSchema: z.ZodType<Prisma.ServiceSelect> = z.object({
...
export const ServiceFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    code: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const ServiceFindManySchema: z.ZodType<Prisma.ServiceFindManyArgs> = z.object({ select: ServiceFindManySelectSchema.optional(), include: z.lazy(() => ServiceIncludeObjectSchema.optional()), orderBy: z.union([ServiceOrderByWithRelationInputObjectSchema, ServiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ServiceWhereInputObjectSchema.optional(), cursor: ServiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ServiceScalarFieldEnumSchema, ServiceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ServiceFindManyArgs>;

export const ServiceFindManyZodSchema = z.object({ select: ServiceFindManySelectSchema.optional(), include: z.lazy(() => ServiceIncludeObjectSchema.optional()), orderBy: z.union([ServiceOrderByWithRelationInputObjectSchema, ServiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ServiceWhereInputObjectSchema.optional(), cursor: ServiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ServiceScalarFieldEnumSchema, ServiceScalarFieldEnumSchema.array()]).optional() }).strict();