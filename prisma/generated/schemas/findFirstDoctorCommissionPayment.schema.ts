...
export const DoctorCommissionPaymentFindFirstSelectSchema: z.ZodType<Prisma.DoctorCommissionPaymentSelect> = z.object({
...
export const DoctorCommissionPaymentFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    amount: z.boolean().optional(),
    paymentDate: z.boolean().optional(),
    paymentMethod: z.boolean().optional(),
...
export const DoctorCommissionPaymentFindFirstSchema: z.ZodType<Prisma.DoctorCommissionPaymentFindFirstArgs> = z.object({ select: DoctorCommissionPaymentFindFirstSelectSchema.optional(), include: z.lazy(() => DoctorCommissionPaymentIncludeObjectSchema.optional()), orderBy: z.union([DoctorCommissionPaymentOrderByWithRelationInputObjectSchema, DoctorCommissionPaymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorCommissionPaymentWhereInputObjectSchema.optional(), cursor: DoctorCommissionPaymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorCommissionPaymentScalarFieldEnumSchema, DoctorCommissionPaymentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DoctorCommissionPaymentFindFirstArgs>;

export const DoctorCommissionPaymentFindFirstZodSchema = z.object({ select: DoctorCommissionPaymentFindFirstSelectSchema.optional(), include: z.lazy(() => DoctorCommissionPaymentIncludeObjectSchema.optional()), orderBy: z.union([DoctorCommissionPaymentOrderByWithRelationInputObjectSchema, DoctorCommissionPaymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorCommissionPaymentWhereInputObjectSchema.optional(), cursor: DoctorCommissionPaymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorCommissionPaymentScalarFieldEnumSchema, DoctorCommissionPaymentScalarFieldEnumSchema.array()]).optional() }).strict();