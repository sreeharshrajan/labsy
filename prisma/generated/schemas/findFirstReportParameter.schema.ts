...
export const ReportParameterFindFirstSelectSchema: z.ZodType<Prisma.ReportParameterSelect> = z.object({
...
export const ReportParameterFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    unit: z.boolean().optional(),
    method: z.boolean().optional(),
...
export const ReportParameterFindFirstSchema: z.ZodType<Prisma.ReportParameterFindFirstArgs> = z.object({ select: ReportParameterFindFirstSelectSchema.optional(), include: z.lazy(() => ReportParameterIncludeObjectSchema.optional()), orderBy: z.union([ReportParameterOrderByWithRelationInputObjectSchema, ReportParameterOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportParameterWhereInputObjectSchema.optional(), cursor: ReportParameterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportParameterScalarFieldEnumSchema, ReportParameterScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReportParameterFindFirstArgs>;

export const ReportParameterFindFirstZodSchema = z.object({ select: ReportParameterFindFirstSelectSchema.optional(), include: z.lazy(() => ReportParameterIncludeObjectSchema.optional()), orderBy: z.union([ReportParameterOrderByWithRelationInputObjectSchema, ReportParameterOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportParameterWhereInputObjectSchema.optional(), cursor: ReportParameterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportParameterScalarFieldEnumSchema, ReportParameterScalarFieldEnumSchema.array()]).optional() }).strict();