...
export const ReportInvoiceFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ReportInvoiceSelect> = z.object({
...
export const ReportInvoiceFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    totalAmount: z.boolean().optional(),
    discount: z.boolean().optional(),
    netAmount: z.boolean().optional(),
...
export const ReportInvoiceFindFirstOrThrowSchema: z.ZodType<Prisma.ReportInvoiceFindFirstOrThrowArgs> = z.object({ select: ReportInvoiceFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ReportInvoiceIncludeObjectSchema.optional()), orderBy: z.union([ReportInvoiceOrderByWithRelationInputObjectSchema, ReportInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportInvoiceWhereInputObjectSchema.optional(), cursor: ReportInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportInvoiceScalarFieldEnumSchema, ReportInvoiceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReportInvoiceFindFirstOrThrowArgs>;

export const ReportInvoiceFindFirstOrThrowZodSchema = z.object({ select: ReportInvoiceFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ReportInvoiceIncludeObjectSchema.optional()), orderBy: z.union([ReportInvoiceOrderByWithRelationInputObjectSchema, ReportInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportInvoiceWhereInputObjectSchema.optional(), cursor: ReportInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportInvoiceScalarFieldEnumSchema, ReportInvoiceScalarFieldEnumSchema.array()]).optional() }).strict();