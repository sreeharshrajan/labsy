...
export const AppSettingValueFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AppSettingValueSelect> = z.object({
...
export const AppSettingValueFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    settingId: z.boolean().optional(),
    setting: z.boolean().optional(),
    value: z.boolean().optional(),
