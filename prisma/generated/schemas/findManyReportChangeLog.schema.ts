...
export const ReportChangeLogFindManySelectSchema: z.ZodType<Prisma.ReportChangeLogSelect> = z.object({
...
export const ReportChangeLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    reportId: z.boolean().optional(),
    userId: z.boolean().optional(),
    changedById: z.boolean().optional(),
...
export const ReportChangeLogFindManySchema: z.ZodType<Prisma.ReportChangeLogFindManyArgs> = z.object({ select: ReportChangeLogFindManySelectSchema.optional(), include: z.lazy(() => ReportChangeLogIncludeObjectSchema.optional()), orderBy: z.union([ReportChangeLogOrderByWithRelationInputObjectSchema, ReportChangeLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportChangeLogWhereInputObjectSchema.optional(), cursor: ReportChangeLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportChangeLogScalarFieldEnumSchema, ReportChangeLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReportChangeLogFindManyArgs>;

export const ReportChangeLogFindManyZodSchema = z.object({ select: ReportChangeLogFindManySelectSchema.optional(), include: z.lazy(() => ReportChangeLogIncludeObjectSchema.optional()), orderBy: z.union([ReportChangeLogOrderByWithRelationInputObjectSchema, ReportChangeLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReportChangeLogWhereInputObjectSchema.optional(), cursor: ReportChangeLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReportChangeLogScalarFieldEnumSchema, ReportChangeLogScalarFieldEnumSchema.array()]).optional() }).strict();