...
export const DoctorAddressFindFirstOrThrowSelectSchema: z.ZodType<Prisma.DoctorAddressSelect> = z.object({
...
export const DoctorAddressFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    doctorId: z.boolean().optional(),
    addressId: z.boolean().optional(),
    isPrimary: z.boolean().optional(),
...
export const DoctorAddressFindFirstOrThrowSchema: z.ZodType<Prisma.DoctorAddressFindFirstOrThrowArgs> = z.object({ select: DoctorAddressFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DoctorAddressIncludeObjectSchema.optional()), orderBy: z.union([DoctorAddressOrderByWithRelationInputObjectSchema, DoctorAddressOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorAddressWhereInputObjectSchema.optional(), cursor: DoctorAddressWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorAddressScalarFieldEnumSchema, DoctorAddressScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DoctorAddressFindFirstOrThrowArgs>;

export const DoctorAddressFindFirstOrThrowZodSchema = z.object({ select: DoctorAddressFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DoctorAddressIncludeObjectSchema.optional()), orderBy: z.union([DoctorAddressOrderByWithRelationInputObjectSchema, DoctorAddressOrderByWithRelationInputObjectSchema.array()]).optional(), where: DoctorAddressWhereInputObjectSchema.optional(), cursor: DoctorAddressWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DoctorAddressScalarFieldEnumSchema, DoctorAddressScalarFieldEnumSchema.array()]).optional() }).strict();